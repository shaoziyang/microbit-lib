...
class DS3231():
    ...
    def setReg(self, reg, dat):
        i2c.write(DS3231_I2C_ADDR, bytearray([reg, dat]))

    def getReg(self, reg):
        i2c.write(DS3231_I2C_ADDR, bytearray([reg]))
        return i2c.read(DS3231_I2C_ADDR, 1)[0]
    ...
    def ALARM(self, day, hour, minute, repeat):
        ...
        if repeat == PER_DISABLE:
            self.setReg(DS3231_REG_CTRL, IE & 0xFC)
            return
        IE |= 0x46
